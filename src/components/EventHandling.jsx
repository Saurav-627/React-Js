  ...
  return (
    <>
      <button
        ...
        className="border-none text-gray-500 bg-red-400 p-2 font-bold text-2xl rounded-2xl my-4"
      >
        Click Me
      </button>{" "}
      <br />
      <button
        ...
        className="border-none text-gray-500 bg-red-400 p-2 font-bold text-2xl rounded-2xl"
      >
        Hover Me
      </button>
    </>
